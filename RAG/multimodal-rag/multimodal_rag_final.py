...
# Define a simple no-op embedding function to avoid downloading models
...
# Create collection with no-op embedding function to avoid downloads
...
query = "pink flower with a yellow center"  # Change the query to test different images or different
...
# # 2. Run: ollama pull llava (for vision capabilities)
# # 3. Run: ollama serve (in another terminal to start the server)
# # =================================
...
# Instantiate the Ollama model with LLaVA (vision-capable open source model)
# LLaVA combines CLIP embeddings with Llama for vision + language understanding
vision_model = ChatOllama(
    model="llava", temperature=0.0, base_url="http://localhost:11434"
)  # This model has vision capabilities and runs locally
